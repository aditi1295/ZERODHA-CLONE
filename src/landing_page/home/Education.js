            ...
            <div className='row'>
                <div className='col-6'>
                   ...
                   <div className='col-6 '>
                    ...
                    <p className='mt-4' >Varsity, the largest online stock market education book in 
                     ...
                     <p className='mt-5'>TradingQ&A, the most active trading and investment community in India for all your
